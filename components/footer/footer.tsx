    ...
    <footer className='bg-[#14151b]'>
      <div className='container'>
        <div className='border-b border-[#ffffff0a]'>
          <div className='grid grid-cols-2 text-white pt-10 items-center'>
            ...
            <ul className='flex gap-6 text-md font-medium font-barlowSemoCondensed justify-end'>
              <li>
        ...
        <div className='py-10'>
          <div className='grid grid-cols-3 text-white'>
            ...
            <div className='border-r border-[#ffffff0a] px-8'>
